            ...
            <div class="w-70 mr-5">
                <div
                    ...
                    <div class="text-center px-6 py-2 pt-6">
                        ...
                        <p class="text-xs mt-4">Let us know what you would like and we'll take a loover over!</p>
                    </div>

                    <form action="#" method="POST" class="space-y-4 px-4 py-6">
                        <div>
                            <input type="text"
                                class="text-sm w-full bg-gray-100 border-none rounded-xl placeholder-gray-900 px-4 py-2"
                        ...
                        <div>
                            <textarea name="idea" id="idea" cols="30" rows="4"
                                class="w-full bg-gray-100 rounded-xl placeholder-gray-900 text-sm px-4 py-2"
                                placeholder="Describe your idea border-none"></textarea>
                        </div>
